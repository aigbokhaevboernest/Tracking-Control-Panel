...
export default function InvoicesPage() {
      ...
      const tpl = buildInvoiceEmail(
  {
    ...
    sender_phone: preview.sender_phone,
    ...
    receiver_phone: preview.receiver_phone,
    ...
    hold_headline: preview.hold_headline,
    hold_body: preview.hold_body,
    hold_contact_email: preview.hold_contact_email,
    crypto_wallet_address: preview.crypto_wallet_address,
    payment_instruction_note: preview.payment_instruction_note,
  },
  {
            ...
            <tbody>
              {isLoading && (
                <TableRowSkeleton
                  columns={5}
                  rows={5}
                  colTypes={["mono", "text", "text", "text", "actions"]}
                />
              )}
